...
testCM("markTextUndo", function (cm) {
    ...
    eqPos(m1Pos.from, {line: 0, ch: 1});
    eqPos(m1Pos.to, {line: 0, ch: 3});
    eqPos(m2Pos.from, {line: 0, ch: 0});
    eqPos(m2Pos.to, {line: 2, ch: 1});
    eqPos(bookmark.find(), {line: 1, ch: 5});
}, {value: "1234\n56789\n00\n"});
...
testCM("wrappingAndResizing", function (cm) {
    ...
    cm.replaceRange("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n!\n", {line: 2, ch: 0});
    forEach([
        {line: 0, ch: doc.length},
        {line: 0, ch: doc.length - 1},
        {line: 0, ch: 0},
        {line: 1, ch: doc.length},
        {line: 1, ch: doc.length - 1}
    ],
        function (pos) {
